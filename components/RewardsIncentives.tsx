      ...
      <div className="relative z-10 max-w-container mx-auto section-padding">
        ...
        <div className="max-w-4xl mx-auto mb-24">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="label mb-6 text-primary">REWARDS & INCENTIVES</div>
            <h2 className="text-5xl font-serif font-medium text-white mb-6 leading-tight">
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          ...
          >
            ...
            <div className="text-white font-semibold text-xl mb-3">Dynamic Cashback</div>
